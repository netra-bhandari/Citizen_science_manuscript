...
ggsave(panel_a, file = "panel1a.png", width = 28, height = 20, units = "in") 
...
ggsave(panel_b, file = "panel1b.png", width = 29, height = 19, units = "in")
...
ggsave(motivation_plot, file = "fig2.png", width = 41, height = 19, units = "in") 
...
ggsave(panel3, file = "fig3.png", width = 35, height = 14, units = "in") 
```

```{r}
#fig 4 types of survey

survey_method <- ques3_plot_2
ggsave(survey_method, file = "fig4.png", width = 13, height = 8, units = "in")
...
ggsave(panel4, file = "fig5.png", width = 40, height = 20, units = "in") 
...
ggsave(uncertainity_plot, file = "fig6.png", width = 13, height = 10, units = "in") 
```
...
ggsave(habitat_preference, file = "fig7.png", width = 41, height = 19, units = "in") 
```

```{r}

temporal_dependence <- lik2
ggsave(temporal_dependence, file = "fig8.png", width = 35, height = 16, units = "in") 
```

```{r}
#fig 9 duration
duration <- ques4a_plot+xlab("Focal taxa")
ggsave(duration, file = "fig9_new.png", width = 14, height = 10, units = "in") 
```

```{r}

#map 
ggsave(map, filename = "map_ms.png",width = 10, height =7, units = "in")
```
...
ggsave(types_of_platforms, filename = "fig1_supp.png",width = 10, height =7, units = "in")
...
## supplementary fig 3
covid_plot <- covid
ggsave(covid, filename = "fig3_supp.png",width = 10, height =9, units = "in")
```
...
ggsave(capture_window, filename = "fig4_supp.png",width = 10, height =7, units = "in")
...
ggsave(trap_scheme, filename = "fig5_supp.png",width = 10, height =8, units = "in")
```

```{r}
## supplementary fig 6 
biodiv_monitor <- exp
ggsave(biodiv_monitor, filename = "fig6_supp.png",width = 5, height =4, units = "in")
...
ggsave(membership, filename = "fig7_supp.png",width = 5, height =4, units = "in")
...
## supplementary fig 8 
skills_plot 
ggsave(skills_plot, filename = "fig8_supp.png", width = 5, height =4, units = "in")
